...
- **PermissionBoundary**
    ...
    - If you wish to set a permission boundary for the stack, set the `PermissionsBoundary` to the arn of the policy you wish to use.
- **KMSKeyARN**
    ...
    - If you wish to use a specific KMS key for the `QUARANTINEBUCKET` and for the `PROMOTEBUCKET`, set the `KMSKeyARN` parameter with the arns of the keys you wish to use.
- **VPC Support**
